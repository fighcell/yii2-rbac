...
use fighcell\rbac\models\Search;
...
abstract class ItemControllerAbstract extends Controller
{
    /**
     * @param  string $name
     * @return \fighcell\rbac\models\Role|\fighcell\rbac\models\Permission
     */
    ...
    {
        /** @var \fighcell\rbac\models\Role|\fighcell\rbac\models\Permission $model */
